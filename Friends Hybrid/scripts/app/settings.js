...
var appSettings = {
    ...
    everlive: {
        apiKey: 'MaerhGxO54DeC8I1', // Put your Backend Services API key here
        scheme: 'http',
        url: ''
    },

    eqatec: {
        productKey: 'dd980788082543f8b785c21afe42ada8',  // Put your EQATEC product key here
        version: '1.0.0.0' // Put your application version here
    },
    
    feedback: {
        apiKey: '2005de00-1f23-11e5-a3bb-3f0f82a7bbf2',  // Put your AppFeedback API key here
        options: {
            enableShake: true,
